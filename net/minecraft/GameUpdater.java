...
public class GameUpdater
  implements Runnable
{
  public String urlFolder = "https://dl.dropbox.com/u/87115331/LauncherUnicraft/Client/", versionFileTxt = "https://dl.dropbox.com/u/87115331/LauncherUnicraft/Client/version_unicraft.txt", zipFile = "https://dl.dropbox.com/u/87115331/LauncherUnicraft/Client/unicraft.zip";
  ...
  protected String getDescriptionForState()
  {
    ...
    case 5:
      return "Extraction des packages.";
    case 6:
  ...
  public void downloadFile(String pathFolder) {
		...
		zip.delete();
		System.out.println("Merci d'utiliser ce launcher, decompilé et amelioré par Azurex");
}
     ...
     this.percentage = 5;
   	try
   	{
         ...
         if(this.forceUpdate == 1) {
          ...
          File current_versionLauncher = new File(dir, "version_unicraft.txt");
